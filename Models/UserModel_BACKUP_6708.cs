...
>>>>>>> 4a48f055184ee066d1fc1ca1d1eeabde840ed0ad
        ...
        [RegularExpression("^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[\\.#?!@$%^&*-]).{6,}$",
            ErrorMessage = "The password must contain at least one uppercase character, one lowercase, one numeric caracter and one special character." +
